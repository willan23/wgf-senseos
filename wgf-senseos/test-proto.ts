...
import { encodeCsiFrameBatch, decodeCsiFrameBatch } from '../packages/uwsc-edge-protocol/src/proto';
import { MessageEnvelope, CsiFrameBatchPayload } from '../packages/uwsc-edge-protocol/src/index';
